...
export const ProductDetailsOverviewTab = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="divide-y divide-slate-100 border border-slate-100 rounded-xl overflow-hidden bg-slate-50/50">
          ...
          <div className="grid grid-cols-3 p-3 text-xs">
            ...
            <span className="col-span-2 font-bold text-slate-800">Piece</span>
          </div>
      ...
      {/* Description Section */}
      <div>
        <h3 className="text-sm font-bold text-slate-800 border-b border-slate-100 pb-2 mb-2">
          Description
        </h3>
      ...
      <div className="pt-2">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            onClick={onEdit}
            className="flex items-center gap-1.5 h-9 px-3.5 rounded-lg border border-slate-200 bg-white text-xs font-bold text-slate-600 hover:bg-slate-50 hover:text-slate-900 transition shadow-sm"
          >
            <Pencil size={13} />
          ...
          <button
            onClick={onArchive}
            className="flex items-center gap-1.5 h-9 px-3.5 rounded-lg border border-rose-200 bg-rose-50/10 text-xs font-bold text-rose-600 hover:bg-rose-50 transition shadow-sm"
          >
            <Trash2 size={13} />
